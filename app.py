...
def produce_pi(scale):
    ...
    conf = SparkConf().setAll([('spark.executor.memory', '3G'), ('spark.executor.cores', '1'), ('spark.cores.max', '1'), ('spark.default.parallelism','84'), ('spark.driver.memory', '16G'), ('spark.storage.memoryFraction', '0.8')])
    spark.stop()
